...
blocks = [Image.open("assets/textures/shiny_pieces/red.png"),
          ...
          Image.open("assets/textures/shiny_pieces/violet.png"),
          Image.open("assets/textures/shiny_pieces/yellow.png"),
          Image.open("assets/textures/shiny_pieces/teal.png"),
          Image.open("assets/textures/shiny_pieces/orange.png")]
...
pack.save("assets/textures/shiny_pieces/pack.png")
